...
| AMD EPYC     | meta-llama/Meta-Llama-3-8B-Instruct | 64 vCPUs, 100 GB disk, 256 GB RAM, and Ubuntu 24.04                     | AWS Instances (e.g., `m7a`)                                                                 |
| AMD Instinct | meta-llama/Llama-3.1-405B           | GPU: 8× MI300X, 1536 GB vRAM, and Ubuntu 24.04                          | [AMD Developer Cloud](https://amd.digitalocean.com/login), Oracle Cloud (`BM.GPU.MI300X.8`) |
|              |                                     |                                                                         | AWS Instances, Azure Instances, Google Cloud Instances                                      |
